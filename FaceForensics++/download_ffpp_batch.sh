...
python faceforensics_download_v4.py ./ -d Deepfakes -c c40 -t videos --server EU2

## Download 'Face2Face' dataset
echo "Downloading 'Face2Face' dataset"
python faceforensics_download_v4.py ./ -d Face2Face -c c40 -t videos --server EU2

## Download 'FaceShifter' dataset
echo "Downloading 'FaceShifter' dataset"
python faceforensics_download_v4.py ./ -d FaceShifter -c c40 -t videos --server EU2

## Download 'FaceSwap' dataset
echo "Downloading 'FaceSwap' dataset"
python faceforensics_download_v4.py ./ -d FaceSwap -c c40 -t videos --server EU2

## Download 'NeuralTextures' dataset
echo "Downloading 'NeuralTextures' dataset"
python faceforensics_download_v4.py ./ -d NeuralTextures -c c40 -t videos --server EU2